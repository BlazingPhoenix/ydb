...
public:
    ...
    NTabletFlatExecutor::ITransaction* CreateTxReply(TEvDataShard::TEvClusterTreeRecalculateResponse::TPtr& response);
    ...
    void Handle(TEvDataShard::TEvClusterTreeRecalculateResponse::TPtr& ev, const TActorContext& ctx);
